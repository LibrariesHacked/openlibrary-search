...
create index ix_works_data_authors on works using gin ((data->'authors') jsonb_path_ops);
...
create index ix_works_description on works using gin ((data->>'description') gin_trgm_ops);