...
create index ix_editions_isbn on editions using gin ((data->'isbn') jsonb_path_ops);
create index ix_editions_isbn13 on editions using gin ((data->'isbn_13') jsonb_path_ops);
create index ix_editions_isbn10 on editions using gin ((data->'isbn_10') jsonb_path_ops);
